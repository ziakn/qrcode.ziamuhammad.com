...
export const metadata: Metadata = {
  ...
  description: "Browse 20+ professional custom QR code templates. Find ready-to-use designs for restaurants, real estate, social media profiles, and business cards.",
